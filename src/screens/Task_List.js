...
export default class Task_List extends Component {
    ...
    alternar_tela_add = () => {
        this.setState({
            mostrar_tela_add: !this.state.mostrar_tarefas_add
        })
    }
    ...
    render() {
        ...
        return (
            <View style={styles.principal}>
                <AddTask visible={this.state.mostrar_tela_add} cancelar = {mostrar.alternar_tela_add}/>
                ...
                <TouchableOpacity style={styles.botao_add} onPress={this.alternar_tela_add}>
